                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover ">
                                ...
                                <tbody>
									...
									<tr>
									<td><img src="{{$list->thumbnail_url}}" width="60px"></td>
									<td>{{ $list->name}}</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addEditModalLabel">Add Brand</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
    	<form  method="post" action="{{url('admin/product/config/brand/save')}}" enctype="multipart/form-data">
		@csrf
      ...
      <div class="modal-body">
       	<div class="form-row">
             <div class="form-group col-12">
                <label>Brand</label>
                <input type="text" class="form-control" name="name" id="name" placeholder="Brand">
            </div>   
        </div>  
        <div class="form-row">   
          	<div class="form-group col-12">
...
$(document).ready(function () {
    ...
    var siteurl="{{url('admin/product/config/brand')}}"
	$(document).on("click", ".edit-data-btn", function () {
        ...
        $.ajax({
            ...
            success: function (data, status, xhr) {
				$('#addEditModalLabel').text('Edit Brand');
				console.log(data);
                if (data.status == 1) {
                    ...
                    if(result.logo){
                    $('#editImage').html('<img src="'+result.thumbnail_url+'" width="120px">')
                    }
                    $("#addEditModal").modal({
						 backdrop: 'static',
						 keyboard: false
