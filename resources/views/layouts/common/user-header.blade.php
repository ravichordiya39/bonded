<header class="header-section">
  ...
  $usercart=\App\Models\Cart::where(['user_id'=>$user->id,'status'=>1])->count();
  $cartitem+=$usercart;
  $wishitem=\App\Models\Product\ProductBookmark::where(['user_id'=>$user->id,'status'=>1])->count();
  @endphp
              ...
              <div class="header-shop-menu">
                <ul class="header-shop-link">
                    ...
                    <div class="search-wrapper"> <a href="javascript:void(0);" class="search-cancel">Cancel</a>
                      <div class="searchForm">
                        <form action="#" method="get">
                          <input type="search" name="s" id="productSearch" class="serach-input" placeholder="Search Products">
                  ...
                  <li class="acoount-icon dropdown">
                    <a class="account-toggle" href="#" data-toggle="dropdown" aria-haspopup="true"
                      aria-expanded="false">
                    ...
                    <div class="account-menu dropdown-menu dropdown-menu-right">
                      <p class="pl-3 m-2">Hi, {{$user->name}}</p>
                      <ul class="account-menu-list">
                        <li><a href="{{url('user/dashboard')}}"><i class="fa fa-user"></i>My Account </a> </li>
                        <li><a href="{{url('user/address')}}"><i class="fa fa-address-book"></i>My Address </a> </li>
                        <li><a href="{{url('user/order')}}"><i class="fa fa-shopping-basket"></i>My Orders </a> </li>
                        <li><a href="{{url('user/product/wishlist')}}"><i class="far fa-heart"></i>My Wishlist </a> </li>
                        <li><a href="{{url('user/coupon')}}"><i class="fa fa-tags"></i>My Coupons </a> </li>
                        <li class="logout">
                  ...
                  <li class="shoping-icon">
                    <a href="{{url('user/product/wishlist')}}">
                      <span class="shop-icon"><svg viewBox="0 -28 512.001 512" xmlns="http://www.w3.org/2000/svg">
                        ...
                        </svg><span class="shop-number wishlist-number ">{{$wishitem}}</span></span> </a>
                  </li>
