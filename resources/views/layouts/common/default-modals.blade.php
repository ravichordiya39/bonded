                            ...
                            <div class="modal-left-wrap">
                                ...
                                required autocomplete="current-password" placeholder="Password">
                                    ...
                                    <div class="login-social">
                                        ...
                                        <div class="social">
                                            <ul class="social-icon">
                                                <li class="facebook"><a href="{{ url('auth/facebook') }}"><i class="fab fa-facebook-f"></i></a></li>
                                                <li class="google"><a href="{{ url('auth/google') }}"><i class="fab fa-google"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="loginregister-now">
                                        <h4>New to Abeer ?</h4>
                                        <a href="javascript:void(0)" class="account-link register">Sign Up?</a>
                                    </div>
                                </div>
                                <div class="modal-register d-none">
            						...
            						<input type="hidden" name="user_type" value="user">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="password"
                                			name="password_confirmation" required class="form-control" id="password_confirmation" placeholder="Password">
                                        </div>          
                                        <div class="form-submit">
                                          <button type="submit" id="submit" class="btn btn-primary">Create an account</button>
                                        </div>
                                      </form>  
                                      <div class="login-social">
