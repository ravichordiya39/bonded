<aside class="admin-sidebar">
    <div class="admin-sidebar-brand">
        ...
        <span class="admin-brand-content font-secondary"><a href="{{url('admin/dashboard')}}"><img class="admin-brand-logo" src="{{url('/')}}/public/front_new/images/logo.png" width="80" alt="kalila Logo"></a></span>
        ...
        <ul class="menu">
            ...
            <li class="menu-item ">
                ...
                <ul class="sub-menu">
                    ...
                    {{-- <li class="menu-item">
                        <a href="https://bonded-coir.com/admin/new-orders" class=" menu-link">
                            <span class="menu-label">
            ...
            <li class="menu-item ">
                ...
                <ul class="sub-menu">
                    <li class="menu-item">
                        <a href="https://bonded-coir.com/admin/add-testimonial" class=" menu-link">
                            <span class="menu-label">
            ...
            <li class="menu-item ">
                ...
                <ul class="sub-menu">
                    <li class="menu-item">
                        <a href="https://bonded-coir.com/admin/reports/sale-report" class=" menu-link">
                            <span class="menu-label">
                    ...
                    <li class="menu-item">
                        <a href="https://bonded-coir.com/admin/reports/customer-report" class=" menu-link">
                            <span class="menu-label">
                    ...
                    <li class="menu-item">
                        <a href="https://bonded-coir.com/admin/reports/inventory-report" class=" menu-link">
                            <span class="menu-label">
            ...
            <li class="menu-item ">
                ...
                <ul class="sub-menu">
                    <li class="menu-item">
                        <a href="https://bonded-coir.com/admin/payment-setting" class=" menu-link">
                            <span class="menu-label">
                    ...
                    <li class="menu-item">
                        <a href="https://bonded-coir.com/admin/view-offers" class=" menu-link">
                            <span class="menu-label">
                                <span class="menu-name">View Users </span>
                            </span>
                            <span class="menu-icon">
                    ...
                    <li class="menu-item">
                        <a href="https://bonded-coir.com/admin/referral-settings" class=" menu-link">
                            <span class="menu-label">
                    ...
                    <li class="menu-item">
                        <a href="https://bonded-coir.com/admin/shipping-settings" class=" menu-link">
                            <span class="menu-label">
                    ...
                    <li class="menu-item">
                        <a href="https://bonded-coir.com/admin/newsletter-listing" class=" menu-link">
                            <span class="menu-label">
