            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="onloadmodal text-center">
                        ...
                        <form class="newsletter-popup-form" method="post" action="{{url('newsletter')}}">
                            <div class="form-group">
                                <input type="email" placeholder="Your Email Here" class="form-control" name="email">
                            </div>
                            <div class="form-btn"><button type="submit" class="btn btn-primary">Let's do This !</button></div>
                        </form>
                        <div class="social">
