                ...
                <div class="col-lg-12">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h5 class="m-b-0">
                                <i class="mdi mdi-checkbox-intermediate"></i> Blog List
                                <div class="pull-right"><a href="{{url('admin/blog/add')}}" class="btn btn-primary"> Add Blog</a></div>
                            </h5>
                                ...
                                <table class="table table-hover ">
                                    ...
                                    <tbody>
									   ...
									   <tr>
									     ...
									     <td>{{$list->cat->name??''}}</td>
									     <td>{{$list->scat->name??''}}</td>
									     <td>{{$list->title}}</td>
									     <td><img src="{{$list->thumbnail_url}}" width="100px"></td>
									     <td>{{$list->title}}</td>
									     ...
									     <td>
									        ...
									        @endif
										 	<!-- <a href="javascript:;" class="btn  btn-primary"> View</a> -->
										  	<a href="{{url('admin/blog/edit')}}/{{$list->id}}" class="btn  btn-primary"> Edit</a>
