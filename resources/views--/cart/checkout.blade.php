                          ...
                          <table class="shop_table checkout-review-order-table">
                              ...
                              <tfoot>
                                  ...
                                  <tr class="order-total">
                                      ...
                                      <td class="text-right"><strong><span class="Price-amount amount"><span class="Price-currencySymbol">₹</span> {{$price+$tax+$shipping}}</span></strong> </td>
                                  </tr>
                              </tfoot>
                          </table>
                      </div><!-- .order-table-wrapper -->
                     <input type="hidden" name="total_price" value="{{$price+$tax+$shipping}}">
          ...
          if(response.status==true){ 
            ...
            $('#apply_coupon').prop('disabled', true);
                    if(response.dis.type=='1'){
                      $('#discount_val').innerHTML='-'+response.dis.type_val;
                      $('#coupon_code_dis_hid').value=response.dis.type_val;
                      var s_total=$('#total_price').value;
                      $('#total_price').value=s_total-response.dis.type_val;
                      $('#total_price_1').value=s_total-response.dis.type_val;
                       $('#total_price2').innerHTML=s_total-response.dis.type_val;
                      $('#total_price').innerHTML=s_total-response.dis.type_val;
                      $('#total_price_99').innerHTML=s_total-response.dis.type_val;
                     
                    }
                    else{
                      var s_total=$('#price').value;
                      var dis=(s_total*response.dis.type_val)/100;
                      $('#discount_val').innerHTML='-'+dis;
                      $('#coupon_code_dis_hid').value=dis;
                      $('#total_price').value=s_total-dis;

                       $('#total_price_1').value=s_total-response.dis.type_val;
                       $('#total_price_2').innerHTML=s_total-response.dis.type_val;

                      $('#total_price').innerHTML=s_total-dis;
                      $('#total_price_99').innerHTML=s_total-dis;
                    ...
                    $('#coupon_code_hid').value=response.status; 
                    $('#coupon_code_dis_type_hid').value='';
                    $('#coupon_code_dis_hid').value='';
                    $('#coupon_code_minimum_purchase').value='';
